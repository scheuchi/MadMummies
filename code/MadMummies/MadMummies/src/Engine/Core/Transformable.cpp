...
void Transformable::GetRotation(glm::vec3& rotation, glm::float_t& angle) { rotation = m_rotation; angle = m_rotationAngle; }
void Transformable::Rotate(glm::vec3& rotate, glm::float_t angle) { }

void Transformable::SetTranslation(glm::vec3& tranlsation) { }
glm::vec3& Transformable::GetTranslation() { return m_translation; }
void Transformable::Translate(glm::vec3& translate) { }

void Transformable::SetScaling(glm::vec3& scaling) { }
glm::vec3& Transformable::GetScaling() { return m_scaling; }
